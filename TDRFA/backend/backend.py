...
import random
import math
from utils import get_expenditure
...
def analysis():
    ...
    if user.total_cost >= user.total_income:
        print('Time to check all your bills, see how you can better survive for next year!\n')

    user.budget_calculator()
    print("Well, I know I am bad at jokes, but anyway, let’s get on the road trip! To get us started, let me know what is your budgeted expenditure for the current year?")

    user.budget_breakdown(get_expenditure())
